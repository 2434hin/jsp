...
public class FileuploadServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 어떤 파일을 업로드 해도 파일명이 brown.png로 고정됨 --> 실제 업로드한 파일명으로 수정
		...
		// 파일 업로드 날짜의 년월 폴더를 체크하여 일 단위로 파일을 관리
		// ex : E:\\upload\\2019\\08
		//part.write("E:\\upload\\" + UUID.randomUUID().toString() + FileuploadUtil.getFilename(part.getHeader("Content-Disposition")));
